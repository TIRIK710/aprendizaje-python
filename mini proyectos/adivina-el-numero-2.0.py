...
contador = 0 
contador_intentos = max_intentos # intentos del usuario (dependiendo de la dificultad elejida)
...
"""))
    ...
    if eleccion == numero_random:
        print(f"Correcto. El numero era {numero_random}. Intentos sobrantes: {contador_intentos - 1}")
    ...
    print(f"Se acabaron los intentos. Perdiste. El número era {numero_random}.")
